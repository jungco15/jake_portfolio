    ...
    return (
        <div className="bg-inherit pt-4 md:px-[8rem] h-full w-full items-center justify-center flex overflow-x-hidden" id='about'>
            <div className="bg-inherit w-full h-full rounded-lg block items-center justify-center">
                ...
                <p className='text-black px-3 pt-2 md:text-2xl md:text-center font-normal' data-aos="fade-left">
                ...
                <p className='text-gray px-3 pt-4 md:text-2xl md:text-center font-normal' data-aos="fade-left">
            ...
            <div className='justify-center items-center flex pb-10 -mt-20' data-aos="fade-left">
            <img src={picko} ></img>
            </div>
                <div className='h-screen w-full block pt-4 md:justify-center md:items-center '>
                    ...
                    <ul className='list-disc list-inside block px-10 md:flex md:pt-4 md:text-center md:items-center md:justify-center '>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Circuit Design</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">SolidWorks Software</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Troubleshooting</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Embedded Systems</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Renewable Energy Systems</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">IoT Development</li>
                    </ul>
                    ...
                    <ul className='list-disc list-inside block px-10 md:flex md:pt-4 md:text-center md:items-center md:justify-center '>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Team Collaboration</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Problem-Solving</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Communication</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Adaptability</li>
                        <li className='font-normal text-sm px-0 w-full md:text-lg' data-aos="fade-left">Critical Thinking</li>
                    </ul>
                </div>
            </div>
        </div>
